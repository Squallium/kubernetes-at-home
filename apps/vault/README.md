...
helm upgrade vault hashicorp/vault -n vault --values apps/vault/values.yaml --values ../kubernetes-at-home-incubator/apps/vault/values.yaml --values apps/vault/values-ssl.yaml  --values ../kubernetes-at-home-incubator/apps/vault/values-ssl.yaml --version 0.32.0 --server-side=false                                                  
```
